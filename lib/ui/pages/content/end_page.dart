...
void newDiff(int cans, int se) {
  ...
  if (cans >= 4 && se < 120) {
    ...
    per.updateDifficult(
        difficulty.difficultyb.value + difficulty.difficultya.value);
  }
}
            ...
            children: [
              Container(
                  ...
                  child: (const Text(
                    ...
                    style: TextStyle(
                        fontSize:
                            32.0), // Ajusta el tamaño de la fuente del texto
                  ))),
              ...
              Container(
                  ...
                  child: (const Text(
                    ...
                    style: TextStyle(
                        fontSize:
                            22.0), // Ajusta el tamaño de la fuente del texto
                  ))),
              const SizedBox(height: 20),
              Container(
              ...
              const SizedBox(height: 20),
              Container(
                color: tempo.getTime() <= 120 && controller.puntuacion >= 4
                    ? Colors.green
                    : Colors.red,
                child: Obx(() {
              ...
              ElevatedButton(
                ...
                child: const Text(
                  'volver', // Muestra el int convertido o un mensaje de error
                  style: TextStyle(
                      fontSize:
                          18.0), // Ajusta el tamaño de la fuente del texto
                ),
